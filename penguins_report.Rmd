...
A Cramer's V test was performed to examine the relationship between sex and body weight in Gentoo penguins. There was a strong influence of the sex on body weight category distribution between all weight classes p<0.05, Cramer's V is `r cramersV.gentoo_weight`.
